     ...
     <div className="container">
            ...
            <div className="card text-center">
                ...
                <div className="input-group mb-3">
                    ...
                    className="form-control" placeholder="Ingresa nombre" aria-label="Username" aria-describedby="basic-addon1" />
                </div>
                ...
                <div className="input-group mb-3">
                    ...
                    className="form-control" placeholder="Ingresa edad" aria-label="Username" aria-describedby="basic-addon1" />
                </div>
                ...
                <div className="input-group mb-3">
                    ...
                    className="form-control" placeholder="Ingresa Años de experiencia" aria-label="Username" aria-describedby="basic-addon1" />
                </div>
                <div className="input-group mb-3">
                    <span className="input-group-text" id="basic-addon1">asignar proyecto: </span>
                    <input type="text" 
                    className="form-control" placeholder="Ingresa nombre de proyecto a asignar" aria-label="Username" aria-describedby="basic-addon1" />
                </div>
                </div>
                ...
                <button  className="btn btn-success" onClick={getEmpleados}>ver datos</button>

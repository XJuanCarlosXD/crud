        ...
        <div className="card text-center">
            ...
            <div className="card-body">
                <div className="input-group mb-3 ">
                    ...
                    className="form-control" placeholder="Ingresa el Nombre del proyecto" aria-label="Username" aria-describedby="basic-addon1" />
                </div>

                <div className="input-group mb-3">
                    <span className="input-group-text" id="basic-addon1">Descripcion del Proyecto: </span>
                    <input type="text"  value={descripcion}
                    onChange={(event)=>{
                    setDescripcion(event.target.value);
                    }}
                    className="form-control" placeholder="Ingresa la descripcion del proyecto" aria-label="Username" aria-describedby="basic-addon1" />
                </div>
            ...
            <div className="card-footer text-muted">
            {
                    ...
                    <button onClick={getProyectos} className="btn btn-success">lista Proyecto</button>
